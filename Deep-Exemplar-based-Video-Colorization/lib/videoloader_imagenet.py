...
class VideosDataset_ImageNet(data.Dataset):
    def __init__(
        ...
        image_pairs = []
#         curr_image_pairs = parse_images(data_root, with_bad, with_mid)  ## DANA
#         image_pairs += curr_image_pairs  ## DANA
#         print("##### parsing image_a pairs in %s: %d pairs #####" % (data_root, len(curr_image_pairs)))  ## DANA
#         if not image_pairs:
#             raise RuntimeError("Found 0 image_a pairs in all the data_roots")   ## DANA

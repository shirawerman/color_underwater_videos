...
if __name__ == "__main__":
    ...
    parser.add_argument("--frame_propagate", default=False, type=bool, help="propagation mode, , please check the paper")
    ...
    if opt.random:
        ...
        print("succesfully load nonlocal model")
        print("succesfully load color model")
        ...
        print("succesfully load nonlocal model: pretrained")
        print("succesfully load color model: pretrained")
    ...
    for ref_name in refs:
        try:
            colorize_video(
                ...
                os.path.join(output_path, clip_name + "_" + ref_name.split(".")[0]),
                nonlocal_net,
                colornet,
                vggnet,
            )
